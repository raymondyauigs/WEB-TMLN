    ...
    var dialog = (function () {
        ...
        */
        ...
        return {
            ...
            setAttrs: function (name, key, value) {
                var button = this.elements.footer.querySelector('[name="' + name + '"]');
                if (button) {
            ...
            */
            setHeader: function (content) {
                ...
                if (this.__internal.options.mode) {
                    if (this.__internal.options.mode !== 'normal') {
                        this.elements.header.setAttribute('mode', this.__internal.options.mode);
                    }
                }
                return this;
            },
